        ...
        <div className="user-modal-overlay open">
            <div className="user-modal" style={{maxWidth: '500px'}}>
                ...
                <div className="user-modal-content">
                    ...
                    <input type="text" placeholder="Buscar por nombre o email..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} style={{width: '100%', padding: '8px', marginBottom: '10px'}}/>
                    {isLoading ? <p>Cargando...</p> : (
                        <ul className="selection-list" style={{maxHeight: '200px', overflowY: 'auto'}}>
                    ...
                    <div className="navigator-buttons" style={{justifyContent: 'flex-end', marginTop: '20px'}}>
